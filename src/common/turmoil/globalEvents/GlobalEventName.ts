export enum GlobalEventName {
    ...
    TAXATION_OF_VENUS = 'Taxation of Venus',
    VENUS_MINING = 'Venus Mining',
    DEGREDATION_OF_VENUS = 'Degredation of Venus',
    FLOATER_TECHNOLOGY = 'Floater Technology',
    VENUSIAN_ECOSYSTEMS = 'Venusian Ecosystems',
    SOCIETIES_OF_VENUS = 'Societies of Venus',
    ANTICORROSIVE_MATERIALS = 'Anticorrosive Materials',
    LOWLAND_FLOODING = 'Lowland Flooding',
    COMMUNITY_SERVICES = 'Community Services',
    POWER_FAILURE = 'Power Failure',
    INTERSTELLAR_COLONIZATION = 'Interstellar Colonization',
    COLONY_PRODUCTIVITY = 'Colony Productivity',
    COMMAND_ECONOMY = 'Command Economy',
    JOVIAN_WAR = 'Jovian War',
