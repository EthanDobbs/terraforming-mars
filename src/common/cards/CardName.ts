export enum CardName {
  ...
  HIRED_RAIDERS_UNDERWORLD = 'Hired Raiders:u',
    ...
    PANSPERMIA_SURVEY = 'Panspermia Survey',  
    ...
    HALOGEN_RECONSTRUCTORS = 'Halogen Reconstructors',
    ANTI_OXIDATION_BACTERIA = 'Anti-Oxidation Bacteria',
    THALLOPHYTE_PROTISTS = 'Thallophyte Protists',
    CARBON_LATTICE_MICROBES = 'Carbon Lattice Microbes',
    ...
    ESSENTIAL_SYMBIOTICS = 'Essential Symbiotics',
    ...
    INDUSTRIAL_COMPOSTING = 'Industrial Composting',
    ...
    ALGAE_BIOREACTORS_CHEMICAL = 'Algae Bioreactors:chemical',
    ...
    SPECULATIVE_MARKETS = 'Speculative Markets',
    RESEARCH_GRANT_CHEMICAL = 'Research Grant:chemical',
    SMALL_SUPPLY_DROP = 'Small Supply Drop',
    HERMES_MISSION = 'Hermes Mission',
    ASSET_LIQUIDATION = 'Asset Liquidation',
    PARASITE = 'Parasite',
    ROBOTICS_EXHIBITION = 'Robotics Exhibition',
    ...
    INDUSTRY_ALLIES = 'Industry Allies',
    ...
    TERRITORY_OCCUPATION = 'Territory Occupation',
    ...
    TERRESTRIAL_PLANET_MISSION = 'Terrestrial Planet Mission',   
    HYDROGEN_BOMBARDMENT_CHEMICAL = 'Hydrogen Bombardment:chemical',
    EXPERIMENTAL_ORGANISMS = 'Experimental Organisms',
    VENUSIAN_INDUSTRIES = 'Venusian Industries',
