...
import {BehaviorComponent, Priority} from './BehaviorComponent';
...
export class AddResourcesToCard extends BehaviorComponent {
  constructor(
    /** The card type to add to. Undefined means any resource. */
    public resourceType: CardResource | undefined,
    public options: Options = {},
  ) {
    super(Priority.GAIN_RESOURCE_OR_PRODUCTION);
  }
