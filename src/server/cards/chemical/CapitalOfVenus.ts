  ...
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Requires Venus 22% or higher. Lower your energy production 2 steps and raise your MC production 5 steps. Place a city tile ON THE RESERVED AREA. Add any 2 resources to any Venus card.',
      },
    });
  }
}
