export enum CardName {
  ...
  HIRED_RAIDERS_UNDERWORLD = 'Hired Raiders:u',
    ...
    PANSPERMIC_ASTEROID = 'Panspermic Asteroid',
    INSTANTIATED_SOLAR_FLARE = 'Instantiated Solar Flare',
    HIGH_SPEED_COMET = 'High Speed Comet',
    TITANIUM_COMET = 'Titanium Comet',
    GIANT_CARBONATE_ASTEROID = 'Giant Carbonate Asteroid',
    CARBONATE_ASTEROID = 'Carbonate Asteroid',
    ACCELERATED_IMPACTOR = 'Accelerated Impactor',
    IRON_RICH_ASTEROID = 'Iron-Rich Asteroid',
    MINOR_IMPACTOR = 'Minor Impactor',
    CONVOY_FROM_TITAN = 'Convoy From Titan',
    HYDROGEN_FROM_SATURN = 'Hydrogen From Saturn',
    EXPEDITION_TO_DIONE = 'Expedition To Dione',
    LARGE_THERMAL_DETONATOR = 'Large Thermal Detonator',
    SUBCRUST_VAPOR_TRAPPING = 'Subcrust Vapor Trapping',
    CYANOBACTERIA_BLOOM = 'Cyanobacteria Bloom',
    HABITAT_CONSERVATION = 'Habitat Conservation',
    ARCHIVAL_STUDIES = 'Archival Studies',
    OVERCLOCK = 'Overclock',
    EARLY_EXPEDITION_CHEMICAL = 'Early Expedition:chemical',
    ASTEROID_STUDY = 'Asteroid Study',
    NITROGEN_ASTEROIDS = 'Nitrogen Asteroids',
    OXYGENATED_COMETS = 'Oxygenated Comets',
    KUIPER_BELT_ICE_ASTEROIDS = 'Kuiper Belt Ice Asteroids',
    CERES_MINING_OPERATIONS = 'Ceres Mining Operations',
    AMMONIA_HEAVY_ASTEROIDS = 'Ammonia Heavy Asteroids',
    ...
    MYCELIUM_FUNGI = 'Mycelium Fungi',
    MACROPLANKTON = 'Macroplankton',
    WATER_SPLITTING_MICROBES = 'Water Splitting Microbes',
    ANTI_OXIDATION_BACTERIA = 'Anti-Oxidation Bacteria',
    THALLOPHYTE_PROTISTS = 'Thallophyte Protists',
    ENZYME_CONSTRUCTORS = 'Enzyme Constructors',
    LATTICE_CONSTRUCTION_MICROBES = 'Lattice Construction Microbes',
    ELECTROPLAQUE_MICROBES = 'Electroplaque Microbes',
    LARGE_AQUATIC_MAMMALS = 'Large Aquatic Mammals',
    TUNDRA_WILDLIFE = 'Tundra Wildlife',
    RAPTORS = 'Raptors',
    FISH_FARMING_LAKE = 'Fish Farming Lake',
    CEPHALOPODS = 'Cephalopods',
    ENDANGERED_SPECIES_REFUGE = 'Endangered Species Refuge',
    NON_HYPOXIC_SMALL_ANIMALS = 'Non-Hypoxic Small Animals',
    SUBTERRANEAN_CREATURES = 'Subterranean Creatures',
    ANTARCTIC_KRILL = 'Antarctic Krill',
    ANCIENT_ARTHROPODS = 'Ancient Arthropods',
    URBAN_WILDLIFE = 'Urban Wildlife',
    HABITAT_DOMES = 'Habitat Domes',
    AQUAPONICS = 'Aquaponics',
    REGOLITH_TREATMENT = 'Regolith Treatment',
    EUROPA_WATER_SPLITTING = 'Europa Water Splitting',
    SILICON_FACTORY = 'Silicon Factory',
    ALUMINUM_FOUNDRY = 'Aluminum Foundry',
    LOCAL_TEMPERATURE_CONTROL = 'Local Temperature Control',
    ADVANCED_GENETIC_ADAPTION = 'Advanced Genetic Adaption',
    OCEANOGRAPHY_RESEARCH = 'Oceanography Research',
    HEAVY_AEROSPACE_TECH = 'Heavy Aerospace Tech',
    FREIGHT_SHUTTLES = 'Freight Shuttles',
    GENETIC_ENGINEERING_LAB = 'Genetic Engineering Lab',
    CO2_VENTS = 'CO2 Vents',
    ECOLOGICAL_CONTRACT = 'Ecological Contract',
    BIODOMES = 'Biodomes',
    TEMPERATE_RAINFOREST = 'Temperate Rainforest',
    BIOMASS_REACTOR = 'Biomass Reactor',
    MICROBE_CULTIVATION_FACILITY = 'Microbe Cultivation Facility',
    BIODIVERSITY_CONTRACT = 'Biodiversity Contract',
    IMPERATIVE_SETTLEMENT = 'Imperative Settlement',
    ECO_CENTRAL = 'Eco-Central',
    SPRAWLING_CITY = 'Sprawling City',
    SUPERPOLYMERS = 'Superpolymers',
    THAW_MINING = 'Thaw Mining',
    INDEPENDENT_SETTLEMENT = 'Independent Settlement',
    MULTIFUNCTIONAL_DOME = 'Multifunctional Dome',
    MINING_COMMUNITY = 'Mining Community',
    DEEP_BURROW_SETTLEMENT = 'Deep Burrow Settlement',
    INSULATED_CITY = 'Insulated City',
    BURIED_SETTLEMENT = 'Buired Settlement',
    INSTITUTE_SETTLEMENT = 'Institute Settlement',
    HUGE_CITY = 'Huge City',
    HUGE_GLACIER = 'Huge Glacier',
    FRESHWATER_LAKE = 'Freshwater Lake',
    DEEP_WELL_PUMP = 'Deep Well Pump',
    GEOTHERMAL_RESERVIOR_HEATING = 'Geothermal Reservior Heating',
    MUNICIPAL_RESERVIOR = 'Municipal Reservior',
    EXPLOSIVES_TEST_SITE = 'Explosives Test Site',
    LUMBER_MILL = 'Lumber Mill',
    COMMERCIAL_IMPORTS = 'Commercial Imports',
    URBAN_DEVELOPMENT = 'Urban Development',
    TUNNEL_BORING = 'Tunnel Boring',
    LITHIUM_MINE = 'Lithium Mine',
    CHASMA_EXCAVATION = 'Chasma Excavation',
    DEEP_POLAR_EXTRACTION = 'Deep Polar Extraction',
    PHOBOS_MINING_OPERATIONS = 'Phobos Mining Operations',
    CALLISTO_OPERATIONS = 'Callisto Operations',
    LASER_FACTORY = 'Laser Factory',
    REGOLITH_AERATION = 'Regolith Aeration',
    MIXOTROPHS = 'Mixotrophs',
    BOTANICAL_LAB = 'Botanical Lab',
    ...
    ANAEROBIC_ENERGY_CROPPING = 'Anaerobic Energy Cropping',
    ADAPTED_HARDWOOD = 'Adapted Hardwood',
    AQUATIC_BIODOMES = 'Aquatic Biodomes',
    CONIFERS = 'Conifers',
    BARLEY = 'Barley',
    WETLANDS_CHEMICAL = 'Wetlands:chemical',
    CACTI = 'Cacti',
    ...
    MONSOONS = 'Monsoons',
    HEAVY_RESPIRATORS = 'Heavy Respirators',
    BEE_FARMING = 'Bee Farming',
    SATURN_GAS_MINE = 'Saturn Gas Mine',
    SPACE_BASED_SOLAR_POWER = 'Space-Based Solar Power',
    LARGE_POWER_PLANT = 'Large Power Plant',
    HYDROCARBON_SYNTHESIS = 'Hydrocarbon Synthesis',
    ATMOSPHERIC_PROCESSING = 'Atmospheric Processing',
    URANIUM_DEPOSIT = 'Uranium Deposit',
    MASSIVE_SOLAR_FARM = 'Massive Solar Farm',
    ENRICHMENT_PLANT = 'Enrichment Plant',
    FUEL_CELL_PRODUCTION = 'Fuel Cell Production',
    ENERGY_MOHOLE = 'Energy Mohole',
    EFFICIENT_BATTERIES = 'Efficient Batteries',
    ADVANCED_HYDROPOWER = 'Advanced Hydropower',
    HIGH_POWER_BETAVOLTAICS = 'High Power Betavoltaics',
    CENTRAL_POWER_PLANT = 'Central Power Plant',
    OSMOTIC_POWER = 'Osmotic Power',
    SOLID_STATE_WIND_ENERGY = 'Solid State Wind Energy',
    ATMOSPHERIC_PRESSURE_ENGINE = 'Atmospheric Pressure Engine',
    ISOTOPE_ENRICHING_BACTERIA = 'Isotope Enriching Bacteria',
    ANAEROBIC_BACTERIA = 'Anaerobic Bacteria',
    CARBONATE_DEPOSIT = 'Carbonate Deposit',
    HFC_PRODUCTION = 'HFC Production',
    GHG_FACTORY_DISTRICT = 'GHG Factory District',
    LASER_CANNON = 'Laser Cannon',
    NATURAL_GAS_EXTRACTION = 'Natural Gas Extraction',
    OZONE_FACTORIES = 'Ozone Factories',
    SYNTHETIC_GROWTH_HORMONES = 'Synthetic Growth Hormones',
    PROBIOTIC_TREATMENT = 'Probiotic Treatment',
    MIRANDA_LABS = 'Miranda Labs',
    MARS_LIFE_SCIENCE_INSTITUTE = 'Mars Life Science Institute',
    SPECIES_CRYOPRESERVATION = 'Species Cryopreservation',
    EARLY_POLAR_OUTPOST = 'Early Polar Outpost',
    RURAL_HOUSING = 'Rural Housing',

    PARASITE = 'Parasite',
    POWER_FAILURE = 'Power Failure',
    FAILED_SPACE_MISSION = 'Failed Space Mission',
    AQUIFER_RELOCATION = 'Aquifer Relocation',
    PUBLIC_RECORDS = 'Public Records',
    ASSET_LIQUIDATION = 'Asset Liquidation',
    SMALL_SUPPLY_DROP = 'Small Supply Drop',
    PATENT_TRADING = 'Patent Trading',
    TECHNOLOGY_EXHIBITION = 'Technology Exhibition',
    RESEARCH_DONATION = 'Research Donation',
    POPULATION_BOOM = 'Population Boom',
    GENETIC_BREAKTHROUGH = 'Genetic Breakthrough',
    ASTROPHYSICS_CENTER = 'Astrophysics Center',
    CENTAUR_LANDINGS = 'Centaur Landings',
    VESTA_OBSERVATORY = 'Vesta Observatory',
    ENCELADUS_OUTPOST = 'Enceladus Outpost',
    MEASUREMENT_DRONES = 'Measurement Drones',
    ADVANCED_BIOMACHINERY = 'Advanced Biomachinery',
    VIRAL_AMEBOID = 'Viral Ameboid',
    LONG_TERM_EVOLUTION_STUDY = 'Long Term Evolution Study',
    LASER_LIGHTSAILS = 'Laser Lightsails',
    ...
    NEURAL_ENCHANCERS = 'Neural Enchancers',
    CONSTRUCTION_CENTER = 'Construction Center',
    TYRRHENUS_ARCHIVES = 'Tyrrhenus Archives',
    MARS_BUSINESS_INVESTMENTS = 'Mars Business Investments',
    CANALS = 'Canals',
    STEEL_EXPORTS = 'Steel Exports',
    JOVIAN_SUPPLIERS = 'Jovian Suppliers',
    PROJECT_ADVANCEMENT = 'Project Advancement',
    SUCCESSFUL_COMMERCE = 'Successful Commerce',
    SCIENTIFIC_SUPPORT = 'Scientific Support',
    GALILEAN_GOVERNOR = 'Galilean Governor',
    MEDIA_CONGLOMARATE = 'Media Conglomerate',
    MARTIAN_BANKING = 'Martian Banking',
    MILITARY_BASE = 'Military Base',
    MILITARY_SPACE_PORT = 'Military Space Port',
    ...
    CONTRACTED_CONSTRUCTION = 'Contracted Construction',
    MOLECULAR_SCIENCE_LAB = 'Molecular Science Lab',
    CROWDFUNDING = 'Crowdfunding',
    COMMUNICATIONS_HUB = 'Communications Hub',
    TITAN_TRADE_HUB = 'Titan Trade Hub',
    CONCRETE_FACTORY = 'Concrete Facotry',
    MOUNTAINTOP_REMOVAL = 'Mountaintop Removal',
    EXPLOSIVE_MINING = 'Explosive Mining',
    PRINT_MANUFACTURING = 'Print Manufacturing',
    VOLCANIC_FOUNDRY = 'Volcanic Foundry',
    SHIPYARD = 'Shipyard',
    HYDRUALIC_MINING = 'Hydrualic Mining',
    UPPER_MANTLE_BORING = 'Upper Mantle Boring',
    SEED_SUPPLIERS = 'Seed Suppliers',
    CASH_CROPS = 'Cash Crops',
    EXTREME_POWER_EFFICIENCY = 'Extreme Power Efficiency',
    COLD_FUSION_POWER = 'Cold Fusion Power',
    NUCLEAR_FORCE_POWER = 'Nuclear Force Power',
    ARTIFICIAL_MICROBIAL_LIFE = 'Artificial Microbial Life',
    ACQUIRED_RESEARCH_FIRM = 'Acquired Research Firm',
    INTERSTELLAR_PROBE = 'Interstellar Probe',
    THEORY_OF_EVERYTHING = 'Theory of Everything',
    GREAT_HARBOR = 'Great Harbor',

    FLOATER_ACQUISITION = 'Floater Acquisition',
    IONIC_GAS_SEQUESTRATION = 'Ionic Gas Sequestration',
    NEAR_MISS_ROTARY_ASTEROID = 'Near-Miss Rotary Asteroid',
    DWARF_PLANET_COLLISION = 'Dwarf Planet Collision',
    CONVOY_TO_VENUS = 'Convoy To Venus',
    HUGE_WATER_SHIPMENTS = 'Huge Water Shipments',
    NITROGEN_FROM_VENUS = 'Nitrogen From Venus',
    ATMOSPHERE_LIFTING_DETONATIONS = 'Atmosphere Lifting Detonations',
    VENUS_MINING_EXPEDITION = 'Venus Mining Expedition',
    ULTRALIGHT_FLOATERS = 'Ultralight Floaters',
    DANU_MONTES_ROVER = 'Danu Montes Rover',
    COLLABORATION_PROJECT = 'Collaboration Project',
    CONSISTENT_BOMBARDMENT = 'Consistent Bombardment',
    PAN_SOLAR_MINING = 'Pan-Solar Mining',
    FLOATING_RESEARCH_BASE = 'Floating Research Base',
    FLOATER_DOCKS = 'Floater Docks',
    MESOSPHERE_SHADES = 'Mesosphere Shades',
    ...
    AIRBORNE_MICROBES = 'Airborne Microbes',
    PH_NEUTRALIZERS = 'pH Neutralizers',
    CARBON_FIXING_MICROBES = 'Carbon Fixing Microbes',
    DESIGNED_FLYERS = 'Designed Flyers',
    VENUS_SURFACE_DWELLERS = 'Venus Surface Dwellers',
    BIOENGINEERING_STUDIES = 'Bioengineering Studies',
    VENUS_BIOLAB = 'Venus Biolab',
    LOCAL_DECOMPRESSION = 'Local Decompression',
    UNDERGROUND_VENUS_BASE = 'Underground Venus Base',
    TOWERS_OF_FREYJA = 'Towers of Freyja',
    VENERA_OUTPOST = 'Venera Outpost',
    VENUS_SOLAR_WAYSTATION = 'Venus Solar Waystation',
    DRY_ICE_RINGS = 'Dry Ice Rings',
    THE_BEHEMOTH = 'The Behemoth',
    VENUS_MINING_INDUSTIRES = 'Venus Mining Industries',
    OVDA_CITY = 'Ovda City',
    CAPITAL_OF_VENUS = 'Capital of Venus',
    HYDROGEN_INJECTION = 'Hydrogen Injection',
    ATMOSPHERIC_SOLAR_COLLECTORS = 'Atmospheric Solar Collectors',
    SWARM_SHADERS = 'Swarm Shaders',
    VORTEX_ENGINE = 'Vortex Engine',
    PHOTONIC_METAMATERIALS = 'Photonic Metamaterials',
    NEUTRALIZER_DRONES = 'Neutralizer Drones',
    CONDENSATION_CATALYSTS = 'Condestation Catalysts',
    BASALT_MINING = 'Basalt Mining',
    VENUSIAN_FUNGI = 'Venusian Fungi',
    LAKE_OF_APHRODITE = 'Lake of Aphrodite',
    SUPER_CARBON_COLLECTORS = 'Super Carbon Collectors',
    SULPHUR_PROCESSING = 'Sulphur Processing',
    STELLAR_CRUISERS = 'Stellar Cruisers',
    ...
    RHIZOBIOME_RESEARCH = 'Rhizobiome Research',
    FLOATING_POWER_STATION = 'Floating Power Station',
    DEUTERIUM_FUSION = 'Deuterium Fusion',
    VENUS_POWER_PLANT = 'Venus Power Plant',
    TERRESTRIAL_ALLIANCE = 'Terrestrial Alliance',
    ECLIPSE_STATION = 'Eclipse Station',
    VENUS_PLANTATION = 'Venus Plantation',
    ...
    WATER_FROM_TITAN = 'Water From Titan',
    METHANE_EXPORTS = 'Methane Exports',
    GALILEAN_MINING_NETWORK = 'Galilean Mining Network',
    TITAN_FUEL_STATION = 'Titan Fuel Station',
    JUPITER_FLOATING_CITY = 'Jupiter Floating City',
    FLOATER_FACILITY = 'Floater Facility',
    FLOATING_TECH_INVESTMENTS = 'Floating Tech Investments',
    PRIMATES = 'Primates',
    ...
    REMOTE_MINING_BASE = 'Remote Mining Base',
    RESEARCH_MISSIONS = 'Research Missions',
    VENUS_TRADE_STATION = 'Venus Trade Station',
    RIM_POPULATION_CENTER = 'Rim Population Center',
    BUSINESS_COLONY = 'Business Colony',
    SELF_SUFFICIENT_COLONY = 'Self-Sufficient Colony',
    INDUSTRIAL_COLONY = 'Industrial Colony',
    DOME_FARMING_COLONY = 'Dome Farming Colony',
    ENERGY_BEAM_COLONY = 'Energy Beam Colony',
    KUIPER_BELT_COLONY = 'Kuiper Belt Colony',
    THERMAL_RESERVIOR = 'Thermal Reservior',
    SLUM_CITY = 'Slum City',
    LUNAR_PORT = 'Lunar Port',
    MUSEUM_OF_LUNA = 'Museum of Luna',
    LUNAR_RESORT = 'Lunar Resort',
    LUNA_COLONIZATION_INVESTMENTS = 'Luna Colonization Investments',
    MICROGRAVITY_LAB = 'Microgravity Lab',
    MILITARY_SPACE_STATION = 'Military Space Station',
    LUNAR_H3_MINING = 'Lunar H3 Mining',
    COLONY_MINING_INFRASTRUCTURE = 'Colony Mining Infrastructure',
    CASSINI_ENTERPRISES = 'Cassini Enterprises',
    HEMERA_BUNKER = 'Hemera Bunker',
    ORBITAL_BIODOMES = 'Orbital Biodomes',
    AZALEA_BUSHES = 'Azalea Bushes',
    WILDFLOWERS = 'Wildflowers',
    COLONY_SPACE_MIRRORS = 'Colony Space Mirrors',
    LUNAR_POWER_GRID = 'Lunar Power Grid',
    PROTO_DYSON_SWARM = 'Proto Dyson Swarm',
    HYDROTHERMAL_VENTS = 'Hydrothermal Vents',
    EARTH_EMBASSY_CHEMICAL = 'Earth Embassy:chemical',
    MERCURIAL_SUNSHADE = 'Mercurial Sunshade',
    HIGH_ORBIT_RESEARCH_STATION = 'High Orbit Research Station',
    TERRESTRIAL_RESEARCH_SUMMIT = 'Terrestrial Research Summit',
    ASTRONOMICAL_CLAIM = 'Astronomical Claim',
    THIN_ATMOSPHERE_FLOATERS = 'Thin Atmosphere Floaters',
    ARCTIC_ENDOLITHS = 'Arctic Endoliths',
    HYPER_EXTREMOPHILE_FUNGI = 'Hyper-Extremophile Fungi',
    BIODIVERSITY_BOOM = 'Biodiversity Boom',
    COLONY_REFORMS = 'Colony Reforms',

    DIRECTED_SABOTAGE_IMPACT = 'Directed Sabotage Impact',
    FUSION_BOMBING = 'Fusion Bombing',
    DEMOCRATIC_REFORM = 'Democratic Reform',
    MEDIA_MANIPULATION = 'Media Manipulation',
    INAUGURATION_CEREMONY = 'Inauguration Ceremony',
    ...
    HYBRID_VESSELS = 'Hybrid Vessels',
    SHORT_TERM_BONUSES = 'Short Term Bonuses',
    MARTIAN_RESEARCH_NETWORK = 'Martian Research Network',
    ENERGY_LAB = 'Energy Lab',
    STIMULUS_PROGRAMS = 'Stimulus Programs',
    COMMITTEE_COALITION = 'Committee Coalition',
    LEGAL_FIRM = 'Legal Firm',
    KICKBACKS = 'Kickbacks',
    REMOTE_AREA_SUPPLIERS = 'Remote Area Suppliers',
    MEDICAL_INSTITUTE = 'Medical Institute',
    MICROBIAL_SUPPORT = 'Microbial Support',
    VENUS_SOCIETY_SUPPORT = 'Venus Society Support',
    PRIMAL_NATIONAL_PARK = 'Primal National Park',
    CORPORATE_CITADEL = 'Corporate Citadel',
    PRESERVATIONIST_SETTLEMENT = 'Preservationist Settlement',
    AUTHORITARIAN_STATE = 'Authoritarian State',
    INDUSTRY_DEVELOPMENT = 'Industry Development',
    ACQUIRED_BIOENGINEERING_FIRM = 'Acquired Bioengineering Firm',
    IONIZING_RADIATION_BEAM = 'Ionizing Radiation Beam',
    REDUCED_SNOW_COVERAGE = 'Reduced Snow Coverage',
    SOCIAL_WELFARE = 'Social Welfare',
    EXOPLANET_LANDING = 'Exoplanet Landing',
    FIRST_MARTIAN_MEMORIAL = 'First Martian Memorial',
    TERRAFORMING_UNION = 'Terraforming Union',
    ACQUIRED_CONSULTING_FIRM = 'Acquired Consulting Firm',

    SPIN_INDUCING_MASS_DRIVERS = 'Spin-Inducing Mass Drivers',
    VENUSIAN_INVERTEBRATES = 'Venusian Invertebrates',
    ALCHEMIC_REACTIONS = 'Alchemic Reactions',
    UNMI_SPONSORSHIP = 'UNMI Sponsorship',
    IMPORTED_NEUTRAL_GASSES = 'Imported Neutral Gasses',
    BIODIVERSITY_GRANTS = 'Biodiversity Grants',
    POULTRY = 'Poultry',
    ADAPTIVE_BIOTICS = 'Adaptive Biotics',
    HIGH_ALTITUDE_STATIONS = 'High-Altitude Stations',

    SPECIAL_DESIGN_CHEMICAL = 'Special Design:chemical',
    AEROBRAKED_AMMONIA_ASTEROID_CHEMICAL = 'Aerobreaked Ammonia Asteroid:chemical',
    SMALL_ASTEROID_CHEMICAL = 'Small Asteroid:chemical',
    GHG_PRODUCING_BACTERIA_CHEMICAL = 'GHG Producing Bacteria:chemical',
    ADAPTATION_TECHNOLOGY_CHEMICAL = 'Adaption Technology:chemical',
    UNDERGROUND_DETONATIONS_CHEMICAL = 'Underground Detonations:chemical',
    SPACE_MIRRORS_CHEMICAL = 'Space Mirrors:chemical',
    EARTH_CATAPULT_CHEMICAL = 'Earth Catapult:chemical',
    MARS_UNIVERSITY_CHEMICAL = 'Mars University:chemical',
    OLYMPUS_CONFERENCE_CHEMICAL = 'Olympus Conference:chemical',
    INDUSTRIAL_CENTER_CHEMICAL = 'Industrial Center:chemical',
    FORCED_PRECIPITATION_CHEMICAL = 'Forced Precipitation:chemical',
    JET_STREAM_MICROSCRAPPERS_CHEMICAL = 'Jet Stream Microscrappers:chemical',
    EXTRACTOR_BALLOONS_CHEMICAL = 'Extractor Balloons:chemical',
    THERMOPHILES_CHEMICAL = 'Thermophiles:chemical',
    VENUS_WAYSTATION_CHEMICAL = 'Venus Waystation:chemical',
    SUBZERO_SALT_FISH_CHEMICAL = 'Sub-Zero Salt Fish:chemical',
    MARTIAN_ZOO_CHEMICAL = 'Martian Zoo:chemical',
    TRADING_COLONY_CHEMICAL = 'Trading Colony:chemical',
    SPINOFF_DEPARTMENT_CHEMICAL = 'Spin-Off Department:chemical',
    DIRECTED_IMPACTORS_CHEMICAL = 'Directed Impactors:chemical',
    ASTEROID_HOLLOWING_CHEMICAL = 'Asteroid Hollowing:chemical',
    ORBITAL_CLEANUP_CHEMICAL = 'Orbital Cleanup:chemical',
    CUTTING_EDGE_TECHNOLOGY_CHEMICAL = 'Cutting-Edge Technology:chemical',
    MEAT_INDUSTRY_CHEMICAL = 'Meat Industry:chemical',
    CARBON_NANOSYSTEMS_CHEMICAL = 'Carbon Nanosystems:chemical',
    SOLAR_LOGISTICS_CHEMICAL = 'Solar Logistics:chemical',
    MARTIAN_LUMBER_CORP_CHEMICAL = 'Martian Lumber Corp:chemical',
    UNDERGROUND_CITY_CHEMICAL = 'Underground City:chemical',
    CLOUD_SEEDING_CHEMICAL = 'Cloud Seeding:chemical',
    BIOMASS_COMBUSTORS_CHEMICAL = 'Biomass Combustors:chemical',
    WORMS_CHEMICAL = 'Worms:chemical',
    ASTEROID_MINING_CONSORTIUM_CHEMICAL = 'Asteroid Mining Consortium:chemical',
    TOLL_STATION_CHEMICAL = 'Toll Station:chemical',
    RESEARCH_CHEMICAL = 'Research:chemical',
    HACKERS_CHEMICAL = 'Hackers:chemical',
    CORPORATE_STRONGHOLD_CHEMICAL = 'Corporate Stronghold:chemical',
    VENUS_SOILS_CHEMICAL = 'Venus Soils:chemical',
    RESEARCH_COLONY_CHEMICAL = 'Research Colony:chemical',
    SPACE_PORT_COLONY_CHEMICAL = 'Space Port Colony:chemical',
    SNOW_ALGAE_CHEMICAL = 'Snow Algae:chemical',
    BACTOVIRAL_RESEARCH_CHEMICAL = 'Bactoviral Research:chemical',

    LEGAL_EXPERTS = 'Legal Experts',
    MATERIAL_LOAN = 'Material Loan',
    RESEARCH_LOAN = 'Research Loan',
    EARLY_LAND_CLAIM = 'Early Land Claim',
    TERRAFORMING_SPONSORS = 'Terraforming Sponsors',
    ENTERTAINMENT_INDUSTRY = 'Entertainment Industry',
    COERCIVE_DEALINGS = 'Coercive Dealings',
    NOCTIS_SETTLEMENT = 'Noctis Settlement',
    AQUAPONICS_FACILITY = 'Aquaponics Facility',
    WILDLIFE_SPONSORS = 'Wildlife Sponsors',
    BLUEPRINT_AI = 'Blueprint AI',
    RARE_MINERAL_RESERVE = 'Rare Mineral Reserve',
    HEAVY_METAL_COMET = 'Heavy Metal Comet',
    BIOPLASTICS = 'Bioplastics',
    INFRASTRUCTURE_SUPPORT = 'Infrastructure Support',
    NUCLEAR_FUEL_MINING = 'Nuclear Fuel Mining',
    ASTEROID_BELT_OPERATIONS = 'Asteroid Belt Operations',
    LUNAR_MINING_INDUSTRIES = 'Lunar Mining Industries',
    LASER_MINING = 'Laser Mining',
    GLACIAL_ALGAE = 'Glacial Algae',
    AMMONIA_ASTEROID = 'Ammonia Asteroid',
    ADAPTED_VASCULAR_GREENERY = 'Adapted Vascular Greenery',
    PROTIST_LIFEFORMS = 'Protist Lifeforms',
    ECOLOGICAL_RESERVE = 'Ecological Reserve',
    POWER_CORE = 'Power Core',
    ENERGY_BEAM = 'Energy Beam',
    THERMAL_PLANT = 'Thermal Plant',
    ADVANCED_HEATING_TECH = 'Advanced Heating Tech',
    NANOTECH_LAB = 'Nanotech Lab',
    ADVANCED_BIOSPHERE = 'Advanced Biosphere',
    RESEARCH_BASE = 'Research Base',
    FURTHER_DEVELOPMENT = 'Further Development',
    CORPORATE_ESPIONAGE = 'Corporate Espionage',
    VENUS_FIRST_CHEMICAL = 'Venus First:chemical',
    AIR_SCRAPPING_OPERATIONS = 'Air Scrapping Operations',
    HYDROGEN_BOMBARDMENT_CHEMICAL = 'Hydrogen Bombardment:chemical',
    EARLY_VENUS_BIOSPHERE = 'Early Venus Biosphere',
    VENUS_SUPPLIER = 'Venus Supplier',
    VENUS_GHG_EXPORTS = 'Venus GHG Exports',
    INNER_SOLAR_MISSION = 'Inner Solar Mission',
    SISTER_PLANET_RESEARCH = 'Sister Planet Research',
    FLOATING_CITY = 'Floating City',
    EARLY_COLONY = 'Early Colony',
    ISOLATED_ECOLOGY_RESEARCH = 'Isolated Ecology Research',
    JOVIAN_PROJECT_BASE = 'Jovian Project Base',
    INTERPLANETARY_TRADING_PORT = 'Interplanetary Trading Port',
    GAS_MINE = 'Gas Mine',
    TRADING_NETWORK = 'Trading Network',
    TITAN_SETTLEMENT = 'Titan Settlement',
